...
# Filter expenses
filtered_expenses = approved_expenses
...
if filtered_expenses:
    ...
    with col1:
        st.metric("✅ Total Aprobados", len(filtered_expenses))
...
# Display expenses
st.subheader(f"📋 Gastos Aprobados ({len(filtered_expenses)})")
...
if filtered_expenses:
    ...
    st.info("📝 No hay gastos aprobados para mostrar.")
